  ...
  const mapExistingApplicationToForm = (
    ...
    try {
      ...
      const formData: DetailData = {
        ...
        pengantar_untuk:
          parsedInfo.pengantar_untuk ||
          "Surat Pengantar Perkembangan Tugas Akhir",
        deskripsi: parsedInfo.deskripsi || "",
        deskripsi_tambahan: parsedInfo.deskripsi_tambahan || [],
        judul: parsedInfo.judul || "",
        nama_dosen_pembimbing_1: parsedInfo.nama_dosen_pembimbing_1 || "",
        nip_dosen_pembimbing_1: parsedInfo.nip_dosen_pembimbing_1 || "",
        nama_dosen_pembimbing_2: parsedInfo.nama_dosen_pembimbing_2 || "",
        nip_dosen_pembimbing_2: parsedInfo.nip_dosen_pembimbing_2 || "",
      };
      ...
      >
        ...
        >
          ...
          <div style={{ width: "100%", maxWidth: "none" }}>
            ...
            {/* Dipindah */}
            {/* <Card title="Deskripsi" className={styles.card} variant="borderless" style={{ marginBottom: 16, width: '100%' }}>
                            <Row gutter={16}>
                                <Col span={24}>
                                    <ProFormTextArea
                                        label={fieldLabels.deskripsi}
                                        name="deskripsi"
                                        rules={[{ required: true, message: 'Mohon diisi' }]}
                                        placeholder="Jelaskan perkembangan tugas akhir Anda secara singkat dan jelas"
                                        fieldProps={{
                                            rows: 4,
                                        }}
                                    />
                            ...
                            <ProFormList
                                ...
                                creatorButtonProps={{
                                    position: 'bottom',
                                    creatorButtonText: 'Tambah Deskripsi',
                                    icon: <PlusOutlined />,
                                    type: 'dashed',
                                    style: { width: '100%' },
                                }}
                                ...
                                deleteIconProps={{
                                    ...
                                    tooltipText: 'Hapus deskripsi ini',
                                }}
                            >
                                <ProFormTextArea
                                    name="deskripsi"
                                    placeholder="Tambahkan deskripsi lainnya"
                                    fieldProps={{
                                        rows: 4,
                                    }}
                                    rules={[
                    ...
                    rules={[
                      {
                        validator: async (_, value) => {
                          const pemb2 =
                            formRef.current?.getFieldValue("pembimbing2_uuid");
                    ...
                    rules={[
                      {
                        validator: async (_, value) => {
                          const pemb1 =
                            formRef.current?.getFieldValue("pembimbing1_uuid");
        ...
        >
          {newFunction(getId, existingApplication)}
        </StepsForm.StepForm>
      </StepsForm>
