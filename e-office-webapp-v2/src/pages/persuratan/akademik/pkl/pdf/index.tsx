      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <Text style={styles.title}>
            Permohonan Surat Pengantar {formData?.pengatar_untuk}
          </Text>
        </View>
        ...
        <View style={styles.formRow}>
          ...
          <Text style={styles.value}>
            {formData?.Departemen || ""} Prodi: {formData?.Prodi || ""} Jenjang:{" "}
            {formData?.jenjang || ""}
          </Text>
        </View>
        ...
        <View style={styles.formRow}>
          <Text style={{ width: 500 }}>
            - Proposal {formData?.pengatar_untuk}
          </Text>
        </View>
        ...
        <View style={styles.signature}>
          <View style={styles.signatureColumn}>
            ...
            <Text style={styles.signatureName}>
              {formData?.nama_dosen_pembimbing}
            </Text>
            <Text style={styles.nip}>
              NIP. {formData?.nip_dosen_pembimbing}
            </Text>
          </View>
          <View style={styles.signatureColumn}>
            <Text>
        ...
        <View style={styles.additionalSignature}>
          ...
          <View style={styles.signatureColumn}>
            ...
            <Text style={styles.signatureName}>
              {formData?.nama_dosen_koordinator}
            </Text>
            <Text style={styles.nip}>
              NIP. {formData?.nip_dosen_koordinator}
            </Text>
          </View>
        </View>
      </Page>
