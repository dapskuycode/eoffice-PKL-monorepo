...
function getStatusDisplay(status: string) {
  const statusMap: Record<string, { label: string; color: string }> = {
    ...
    // Semua status setelah APPROVED_KAPRODI ditampilkan sebagai "Selesai" untuk Ketua Prodi
...
export default function KetuaProdiDashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      if (dashboardData) {
        ...
        const formattedLetters = dashboardData.pengajuan
          .filter((pengajuan: any) => pengajuan.status === 'VERIFIED_ADMIN') // Filter for Dashboard
          .map((pengajuan: any) => {
