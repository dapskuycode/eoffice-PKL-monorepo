...
import { UserOutlined, MailOutlined, BookOutlined, CalendarOutlined, PhoneOutlined, HomeOutlined } from '@ant-design/icons';

const { Title, Text } = Typography;

export default function AdminProdiProfile() {
  const { user } = useAuth();
  ...
  return (
    <div className="p-6">
      <Title level={2}>Profile Admin Prodi</Title>
          ...
          <Card title="Informasi Personal" className="mb-6">
            <Descriptions column={1} bordered>
              ...
              <Descriptions.Item label="Role">
                <Tag color="orange">Admin Program Studi</Tag>
              </Descriptions.Item>
