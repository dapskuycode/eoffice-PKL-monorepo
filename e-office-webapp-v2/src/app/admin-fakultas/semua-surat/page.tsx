...
export default function AdminFakultasSemuaSurat() {
    ...
    const stats = {
        perluTindakan: letters.filter(l => l.rawStatus === 'REGISTERING').length,
        selesai: letters.filter(l =>
    ...
    return (
        <AdminFakultasLayout>
            <div className="mb-8">
                ...
                <p className="text-gray-600">Daftar seluruh surat yang masuk ke Fakultas.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-gray-500 mt-1">Surat belum diregistrasi</p>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-gray-500 mt-1">Surat telah diregistrasi</p>
                    </CardContent>
                </Card>
            ...
            <Card>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-2">
                            ...
                            >
                                ...
                                <option value="REGISTERING">Menunggu Registrasi</option>
                                <option value="REGISTERED">Selesai</option>
                                <option value="REVISI">Perlu Revisi</option>
                                <option value="DITOLAK">Ditolak</option>
                            </select>
                            <div className="relative">
                                <input type="text" placeholder="Cari surat..." className="px-4 py-2 border rounded-lg pr-10 text-sm" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
                ...
                <CardContent>
                    {loading ? (
                        ...
                        <div className="text-center py-10 text-gray-500">Tidak ada data surat</div>
                    ) : (
                                ...
                                <tbody>
                                    {currentLetters.map((letter) => (
                                        <tr key={letter.id} className="border-b hover:bg-gray-50">
                                            ...
                                            <td className="py-3 px-4"><div className="text-sm text-gray-800">{letter.pengusul}</div><div className="text-xs text-gray-500">{letter.nim}</div></td>
                                            ...
                                            <td className="py-3 px-4">
                                                <button className="p-1 hover:bg-gray-200 rounded" onClick={() => router.push(`/admin-fakultas/surat/${letter.id}/review`)}>
