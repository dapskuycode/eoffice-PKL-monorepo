...
export default function EditProdiPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        alert('Gagal mengupdate program studi');
        return;
      }
      ...
      alert('Terjadi kesalahan saat mengupdate program studi');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 pt-16">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Edit Program Studi</h1>
            <p className="mt-2 text-gray-600">Update data program studi</p>
          </div>
        </div>
