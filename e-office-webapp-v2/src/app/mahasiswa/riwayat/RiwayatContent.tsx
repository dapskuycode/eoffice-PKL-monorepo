                ...
                {selectedSurat && (
                    <div style={{ maxHeight: '75vh', overflow: 'auto' }}>
                        {selectedSurat.status === 'COMPLETED' ? (
                                            ...
                                            <div style={{ position: 'relative', marginTop: '100px' }}>
                                                ...
                                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                                                    <div className="signature-block" style={{ width: '250px', textAlign: 'center' }}>
                                                        <p style={{ marginBottom: '4px', textAlign: 'center' }}>Mengetahui,</p>
                                                        <p style={{ marginBottom: '8px', textAlign: 'center' }}>Ketua Departemen/Program Studi</p>
                                                        <div className="signature-wrapper" style={{ height: '80px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                                            {selectedSurat.ttdKetuaProdi ? (
                                                                <img src={selectedSurat.ttdKetuaProdi} alt="TTD Ketua Prodi" style={{ maxHeight: '80px' }} />
                                                            ) : (
                                                                <div style={{ height: '80px' }}></div>
                                                            )}
                                                        </div>
                                                        <p style={{ fontWeight: 'bold', textDecoration: 'underline', marginTop: '8px', textAlign: 'center' }}>
                                                            {selectedSurat.mahasiswa?.programStudi?.ketuaProdi?.name || '(................................)'}
                                                        </p>
                                                        <p style={{ fontSize: '12px', textAlign: 'center' }}>
                                                            NIP. {selectedSurat.mahasiswa?.programStudi?.ketuaProdi?.nip || '................................'}
                                                        </p>
                                                    </div>

                                                    <div className="signature-block" style={{ width: '250px', textAlign: 'center' }}>
                                                        <p style={{ marginBottom: '4px', textAlign: 'center' }}>Semarang, {new Date(selectedSurat.createdAt).toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' })}</p>
                                                        <p style={{ marginBottom: '8px', textAlign: 'center' }}>Hormat kami Mahasiswa,</p>
                                                        <div className="signature-wrapper" style={{ height: '80px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                                            {selectedSurat.tandatangan ? (
                                                                <img src={selectedSurat.tandatangan} alt="Tanda Tangan" style={{ maxHeight: '80px' }} />
                                                            ) : (
                                                                <div style={{ height: '80px' }}></div>
                                                            )}
                                                        </div>
                                                        ...
                                                        <p style={{ fontSize: '12px', textAlign: 'center' }}>
                                                            NIM. {selectedSurat.mahasiswa?.nim || '................................'}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <Empty description="Data surat belum tersedia atau belum difinalisasi." />
                        )}
                    </div>
                )}
            </Modal>
